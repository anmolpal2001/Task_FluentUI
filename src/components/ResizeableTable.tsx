    ...
    <>
      <p>
        ...
        <Input
          ...
          value={
            columnSizingOptions.file.idealWidth
              ? columnSizingOptions.file.idealWidth.toString()
              : ""
          }
        />
      </p>
      <p>
        ...
        <Input
          ...
          value={
            columnSizingOptions.file.minWidth
              ? columnSizingOptions.file.minWidth?.toString()
              : ""
          }
        />
      </p>
      <p>
        <Button
          onClick={addColumn}
          disabled={columns.length === columnsDef.length}
        >
          Add removed column
        </Button>
      </p>
